...
document.querySelector("#function-1V button").addEventListener("click", () => {
  ...
  document.querySelector("#event-6V button").addEventListener("click", () => {
    event.target.parentNode
      .querySelector("input")
      .addEventListener("input", function inputVanilla() {
        document.querySelector("#event-6V .modal__example__try p").innerText =
          event.target.value;
      });
  });
  ...
  document
    .querySelector("#event-7V img")
    .setAttribute(
      "src",
      "https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaPanoramas/horizon_3_back.jpg"
    );
  ...
  document.querySelector("#event-10V select").addEventListener("change", () => {
    document.querySelector("#event-10V .modal__example__try p").innerText =
  ...
  document.querySelector("#event-13V ol").addEventListener("click", () => {
    event.target.parentNode.nextSibling.innerText =
      "Item clicked: " + event.target.innerText;
  });
